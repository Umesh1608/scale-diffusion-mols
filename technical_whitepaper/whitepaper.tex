...
\subsection{Linear Degradation Operator \texorpdfstring{$\Mt$}{M\_t}}\label{sec:degradation}
...
\subsection{\texorpdfstring{$\Mt$}{M\_t} Transpose via Vector-Jacobian Product}\label{sec:vjp}
